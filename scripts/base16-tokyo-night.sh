...
# Tokyo Night scheme by ptgamr based on Tokyo Night theme
export BASE16_THEME=tokyo-night

color00="1a/1b/26" # Base 00 - Black (background)
...
color07="a9/b1/d6" # Base 05 - White (foreground)
color08="41/45/60" # Base 03 - Bright Black
...
color16="ff/9e/64" # Base 09 - Orange
color17="db/4b/4b" # Base 0F - Dark Red
color18="24/28/3b" # Base 01 - Darker background
color19="2e/34/52" # Base 02 - Selection background
color20="78/7c/99" # Base 04 - Comments
color21="c0/ca/f5" # Base 06 - Light foreground
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj 2e3452 # selection color
